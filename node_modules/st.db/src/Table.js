...
class Table extends Database_js_1.Database {
    constructor(key, database) {
        ...
        this.ID = key;
        this.typeof = { ID: typeof this.ID, data: this.database.has(this.ID) ? this.database.type(this.ID) : "object" };
     ...
     */
    get cache() {
        let readFileData = this.database.get(this.ID) || this.database.storageStyle.writing_format([]);
